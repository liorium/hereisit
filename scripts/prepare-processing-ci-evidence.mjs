...
export function validateHostedImageCandidateBinding(reports, candidate) {
  if (
    reports.fullCorpusBenchmark.engineImageDigest !== candidate.engine.oci.configDigest ||
    reports.commercialReview.licenseGateSha256 !==
      candidate.releaseAssets.security.gates.imageEngine.sha256
  ) {
    throw new TypeError("hosted reviews do not bind the exact image candidate");
  }
  return reports;
}
