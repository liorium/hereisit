...
function readyRow() {
  return {
    ...
    costAccountingStartedAt: Date.parse("2026-08-10T00:00:00.000Z"),
    lastSealedHourKey: 496199,
    targetHourKey: 496200,
    targetCostRowPresent: 1,
    targetProviderWorkerUsageComplete: 0,
    targetProviderContainerUsageComplete: 1,
    targetAnalyticsUsageComplete: 0,
    targetProviderUsageComplete: 0,
    targetComplete: 0,
    targetUsageObservationCount: 1,
    targetUsageObservationMatches: 1,
    releaseReportSha256,
  };
}
...
describe("processing public admission state", () => {
  ...
  it("projects the current circuit state without requiring it to be closed", async () => {
    ...
    await expect(
      ...
      lastSealedHourKey: 496199,
      targetHourKey: 496200,
      targetCostRowPresent: true,
      targetProviderWorkerUsageComplete: false,
      targetProviderContainerUsageComplete: true,
      targetAnalyticsUsageComplete: false,
      targetProviderUsageComplete: false,
