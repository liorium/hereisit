...
export const toolCatalog = defineToolCatalog([
  ...
  },
  {
    ...
    outputKinds: ["image/jpeg", "image/png", "image/webp", "image/gif"],
    experience: "file",
    execution: "browser",
  ...
  },
  {
    ...
    outputKinds: ["image/jpeg", "application/zip"],
    experience: "file",
    execution: "browser",
    contract: { id: "image.convert-to-jpg", version: 1 },
    featured: false,
    relatedToolIds: ["image.convert", "image.compress", "image.resize"],
  },
  {
    id: "image.convert-from-jpg",
    name: "JPG에서 변환",
    shortDescription:
      "JPG 이미지를 PNG로 바꾸거나 여러 장을 움직이는 GIF로 만드세요. 파일은 내 기기에서 처리합니다.",
    domains: ["image", "data"],
    purposes: ["convert", "create"],
    searchAliases: aliases["image.convert-from-jpg"],
    rank: 80,
    availability: "available",
    route: "/image/convert-from-jpg",
    launcherInput: {
      role: "source",
      kinds: ["image/jpeg"],
      minFiles: 1,
    ...
    outputKinds: ["image/png", "image/gif", "application/zip"],
    experience: "file",
    execution: "browser",
    contract: { id: "image.convert-from-jpg", version: 1 },
    featured: false,
    relatedToolIds: ["image.convert-to-jpg", "image.convert", "image.editor"],
  },
  {
    id: "image.editor",
    name: "사진 편집",
    ...
    outputKinds: ["image/jpeg", "image/png"],
    experience: "workspace",
    execution: "browser",
    contract: { id: "image.editor", version: 1 },
    featured: false,
    relatedToolIds: ["image.meme", "image.watermark", "image.crop"],
  },
  {
    id: "image.meme",
    name: "밈 만들기",
    ...
    domains: ["image"],
    purposes: ["create", "edit"],
    searchAliases: aliases["image.meme"],
    rank: 90,
    availability: "available",
    route: "/image/meme",
    launcherInput: {
    ...
    experience: "workspace",
    execution: "browser",
    contract: { id: "image.meme", version: 1 },
    featured: false,
    relatedToolIds: ["image.editor", "image.watermark", "image.convert"],
  },
  {
    id: "image.html-to-image",
    name: "HTML을 이미지로",
    shortDescription: "HTML과 CSS를 붙여 넣어 외부 업로드 없이 PNG 이미지로 렌더링하세요.",
    domains: ["image", "web-dev"],
    purposes: ["convert", "create"],
    searchAliases: aliases["image.html-to-image"],
    rank: 95,
    availability: "available",
    route: "/image/html-to-image",
    launcherInput: null,
    outputKinds: ["image/png"],
    experience: "quick",
    execution: "browser",
    contract: { id: "image.html-to-image", version: 1 },
    featured: false,
    relatedToolIds: ["image.editor", "image.convert", "data.json-format"],
  },
  {
    id: "image.upscale",
    name: "이미지 확대",
    ...
    domains: ["image"],
    purposes: ["optimize", "edit"],
    searchAliases: aliases["image.upscale"],
    rank: 18,
    availability: "available",
    route: "/image/upscale",
    launcherInput: {
    ...
    experience: "file",
    execution: "browser",
    contract: { id: "image.upscale", version: 1 },
    featured: false,
  ...
  },
  {
    ...
    experience: "workspace",
    execution: "browser",
    contract: { id: "image.blur-face", version: 1 },
    featured: false,
    relatedToolIds: ["image.remove-background", "image.watermark", "image.editor"],
  },
  {
    ...
    domains: ["image"],
    purposes: ["edit", "protect"],
    searchAliases: aliases["image.remove-background"],
    rank: 16,
    availability: "available",
    ...
    experience: "file",
    execution: "browser",
    contract: { id: "image.remove-background", version: 1 },
    featured: false,
