/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --strict-vars=false src/worker-configuration.d.ts` (hash: 9df4871eff4f370b61101e1e90309ccf)
...
interface __BaseEnv_Env {
	...
	PRODUCT_ANALYTICS_RATE_LIMITER: RateLimit;
	...
	COST_ACCOUNTING_MODE: string;
	LOGPUSH_JOB_ID: string;
	CONTAINER_APPLICATION_ID: string;
	WORKER_SCRIPT_NAME: string;
	USAGE_LOG_PREFIX: string;
	...
	PDF_PUBLIC_ADMISSION_JSON: string;
	IMAGE_COMPRESS_SERVER_ROLLOUT_PERCENT: string;
	MAINTAINER_SESSION_HASHES: string;
	ENGINE_INSTANCE_NAME: string;
	ENGINE_IMAGE_DIGEST: string;
	IMAGE_JOBS_QUEUE_NAME: string;
	IMAGE_JOBS_DLQ_NAME: string;
	PDF_ENGINE_INSTANCE_NAME: string;
	PDF_ENGINE_IMAGE_DIGEST: string;
	PDF_JOBS_QUEUE_NAME: string;
	PDF_JOBS_DLQ_NAME: string;
	IMAGE_ENGINE: DurableObjectNamespace<import("./index").ImageEngineContainer>;
	PDF_ENGINE: DurableObjectNamespace<import("./index").PdfEngineContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ImageEngineContainer" | "PdfEngineContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CLOUDFLARE_ACCOUNT_ID" | "APP_ORIGINS" | "R2_BUCKET_NAME" | "USAGE_LOG_BUCKET_NAME" | "USAGE_ANALYTICS_DATASET_NAME" | "COST_ACCOUNTING_MODE" | "LOGPUSH_JOB_ID" | "CONTAINER_APPLICATION_ID" | "WORKER_SCRIPT_NAME" | "USAGE_LOG_PREFIX" | "ACCOUNT_DAILY_WEIGHTED_UNIT_LIMIT" | "ANONYMOUS_DAILY_WEIGHTED_UNIT_LIMIT" | "NETWORK_DAILY_WEIGHTED_UNIT_LIMIT" | "ACCOUNT_PENDING_JOB_LIMIT" | "NETWORK_PENDING_JOB_LIMIT" | "MAX_QUEUED_AGE_SECONDS" | "MAX_LIVE_MEDIAN_OUTPUT_RATIO_BPS" | "MAX_LIVE_P95_WEIGHTED_UNITS" | "MAX_LIVE_ORIGINAL_RETAINED_RATE_BPS" | "MAX_LIVE_COST_PER_1000_MICROUSD" | "MAX_PROJECTED_MONTHLY_COST_MICROUSD" | "LIVE_COST_MODEL_JSON" | "LIVE_COST_MODEL_SHA256" | "PROVIDER_USAGE_SCHEMA_SHA256" | "RELEASE_REPORT_SHA256" | "PDF_PUBLIC_ADMISSION_JSON" | "IMAGE_COMPRESS_SERVER_ROLLOUT_PERCENT" | "MAINTAINER_SESSION_HASHES" | "ENGINE_INSTANCE_NAME" | "ENGINE_IMAGE_DIGEST" | "IMAGE_JOBS_QUEUE_NAME" | "IMAGE_JOBS_DLQ_NAME" | "PDF_ENGINE_INSTANCE_NAME" | "PDF_ENGINE_IMAGE_DIGEST" | "PDF_JOBS_QUEUE_NAME" | "PDF_JOBS_DLQ_NAME">> {}
}
