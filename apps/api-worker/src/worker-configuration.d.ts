/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --strict-vars=false src/worker-configuration.d.ts` (hash: 15153a2e1d431586ad2fb2b75cb0aa70)
