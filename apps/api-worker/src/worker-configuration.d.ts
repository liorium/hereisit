/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --strict-vars=false src/worker-configuration.d.ts` (hash: c03cacb2bdff057d75b4877809e764bf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CLOUDFLARE_ACCOUNT_ID" | "APP_ORIGINS" | "R2_BUCKET_NAME" | "USAGE_LOG_BUCKET_NAME" | "USAGE_ANALYTICS_DATASET_NAME" | "ACCOUNT_DAILY_WEIGHTED_UNIT_LIMIT" | "ANONYMOUS_DAILY_WEIGHTED_UNIT_LIMIT" | "NETWORK_DAILY_WEIGHTED_UNIT_LIMIT" | "ACCOUNT_PENDING_JOB_LIMIT" | "NETWORK_PENDING_JOB_LIMIT" | "MAX_QUEUED_AGE_SECONDS" | "MAX_LIVE_MEDIAN_OUTPUT_RATIO_BPS" | "MAX_LIVE_P95_WEIGHTED_UNITS" | "MAX_LIVE_ORIGINAL_RETAINED_RATE_BPS" | "MAX_LIVE_COST_PER_1000_MICROUSD" | "MAX_PROJECTED_MONTHLY_COST_MICROUSD" | "LIVE_COST_MODEL_JSON" | "LIVE_COST_MODEL_SHA256" | "PROVIDER_USAGE_SCHEMA_SHA256" | "RELEASE_REPORT_SHA256" | "IMAGE_COMPRESS_SERVER_ROLLOUT_PERCENT" | "MAINTAINER_SESSION_HASHES" | "ENGINE_INSTANCE_NAME" | "ENGINE_IMAGE_DIGEST" | "IMAGE_JOBS_QUEUE_NAME" | "IMAGE_JOBS_DLQ_NAME">> {}
}
