/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --strict-vars=false src/worker-configuration.d.ts` (hash: 5583adbef83d4f05bc2babdad34b80fe)
