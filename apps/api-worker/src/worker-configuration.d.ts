/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --strict-vars=false src/worker-configuration.d.ts` (hash: a392cbe76e8ea6d6b5dd2bb726845e64)
