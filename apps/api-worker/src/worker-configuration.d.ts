/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --strict-vars=false src/worker-configuration.d.ts` (hash: 34735deb8c94ca7e6f3c14f34566b243)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ImageEngineContainer";
	}
