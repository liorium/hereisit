...
export type ArtifactUploadStage = "canonical-head";

export type ArtifactMime = ImageOptimizeMime;
...
export type StoreExactInputArtifactResult =
  ...
  | {
       ...
       * key/size/MIME/upload-version boundary.
       */
 ...
 * R2 is create-only and first-writer-wins.
 */
