...
export function PdfToolPage({ tool }: { tool: PdfToolConfig }) {
    ...
    <main>
      ...
      <section className="tool-hero" aria-labelledby="tool-title">
        ...
        <div className="tool-hero-copy">
          ...
          {tool.warning ? <p className="tool-warning">{tool.warning}</p> : null}
        </div>
      </section>
      ...
      <section className="related-tools-section" aria-labelledby="related-tools-title">
        <div className="section-heading">
          ...
          <h2 id="related-tools-title">다른 PDF 작업도 바로 이어서.</h2>
        </div>
